...
export default class EmpView {
    ...
    editEmployeesForm(response){
        ...
        row.append('<p> <label for="firstName">FirstName </label>' +
            '<input id="firstName" name="firstName" value="'+response.firstName+'" type="text" class = "empForm"> ' +
            '</p>');
        row.append('<p> <label for="secondName">SecondName</label>' +
            '<input id="secondName" name="secondName" value="'+response.secondName+'" type="text" class = "empForm"> ' +
            '</p>');
        row.append('<p> <label for="grade">Gade   </label>' +
            '<input id="grade" name="grade" value="'+response.grade+'" type="number" class = "empForm"> ' +
            '</p>');
        row.append('<p> <label for="birthday">Birthday </label>' +
            '<input id="birthday" name="birthday" value="'+response.birthday+'" type="date" class = "empForm"> ' +
            '</p>');
        row.append('<p> <label for="eMail">eMail </label>' +
            '<input id="eMail" name="eMail" value="'+ response.eMail+'" type="email" class = "empForm"> ' +
            '</p>');
